...
# To decrypt the text, the following procedure is needed: calculate d such that ed=1 mod phi, then
...
# Find the sum of all values of e, 1<e<phi(1009,3643) and gcd(e,phi)=1, so that the number of
